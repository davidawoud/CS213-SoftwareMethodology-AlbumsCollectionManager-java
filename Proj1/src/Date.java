...
{	
    ...
    */
    private boolean isValid_futureDate(int day, int month, int year)
    {
        ...
        Date comparedDate = new Date("" + day + "/" + month + "/" + year); 
    ...
    */
    ...
    @return 1 if the reference is less 
            0 if both dates are the same
            -1 if the reference is greater
    */
    @Override
    ...
    */
    public static void main(String args[]) 
    {
        ...
        System.out.println("1/1/1989: " + result);
        ...
        Date dateTest4 = new Date("12/02/2022"); 
        result = dateTest4.isValid(); 
        System.out.println("12/02/2022: " + result); 
        ...
        Date dateTest7 = new Date("13/06/2001"); 
        result = dateTest7.isValid(); 
        System.out.println("13/06/2001: " + result); 
